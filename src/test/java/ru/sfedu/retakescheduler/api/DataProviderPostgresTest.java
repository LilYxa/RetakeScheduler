...
//		dataProviderXml2.saveSubject(subject);
	...
	public void testSaveScheduleUnitPositive() throws Exception {
		...
		dataProviderPostgres.saveScheduleUnit(scheduleUnit2, TypeOfSchedule.MAIN);
		dataProviderPostgres.saveScheduleUnit(scheduleUnit3, TypeOfSchedule.MAIN);
		assertNotNull(dataProviderPostgres.getScheduleUnitById(scheduleUnit.getScheduleUnitId(), TypeOfSchedule.MAIN));
		assertNotNull(dataProviderPostgres.getScheduleUnitById(scheduleUnit2.getScheduleUnitId(), TypeOfSchedule.MAIN));
		assertNotNull(dataProviderPostgres.getScheduleUnitById(scheduleUnit3.getScheduleUnitId(), TypeOfSchedule.MAIN));
	}
...
//		dataProviderCsv2.saveScheduleUnit(scheduleUnit, TypeOfSchedule.MAIN);
	...
	public void testGetAllStudents() {
		log.debug("testGetAllStudents[1]: start test");
		List<Student> students = dataProviderPostgres.getAllStudents();
		log.debug("testGetAllStudents[2]: students: {}", students);
	...
	public void testGetAllTeachers() {
		...
		log.debug("testGetAllStudents[2]: students: {}", teachers);
	...
	public void testGetAllScheduleUnits() {
		...
		List<ScheduleUnit> scheduleUnits = dataProviderPostgres.getAllScheduleUnits(TypeOfSchedule.MAIN);
		log.debug("testGetAllScheduleUnits[2]: type: {}, scheduleUnits: {}", TypeOfSchedule.MAIN, scheduleUnits);
		assertNotNull(scheduleUnits);
	}

	@Test
	public void testGetAllSubjects() {
		log.debug("testGetAllSubjects[1]: start test");
		List<Subject> subjects = dataProviderPostgres.getAllSubjects();
		log.debug("testGetAllSubjects[2]: subjects: {}", subjects);
